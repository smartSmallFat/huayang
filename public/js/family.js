...
$('.place').eq(0).click(function () {
    ...
    $.ajax({
        url: '/showfamilyPage',
        success: function (res) {
            $('#cre_family').append(`  <div  class="detailPhoto">
                                                <div class="det1">
                                                <div class="dp1"></div>
                                                <section class="box">
                                                <span>￥${res[0].m_nowPrice}</span>
...
$('.place').eq(7).click(function () {
    $('#cre_family').html('');
    $('#cre_family').append('<span id="other_add">其他站点正在开发中，请<a href="">联系客服</a></span>')
    $('#other_add').css({
        'color':'red',
        'font-size':'16px',
        'margin-left':'540px',
...
$('.box1').on('click','a',function () {
    ...
    window.location.href="http://localhost:8084/pages/family.det.html?id="+sId+""
